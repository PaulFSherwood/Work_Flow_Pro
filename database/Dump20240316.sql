...
--
-- Table structure for table `debrief`
--
...
CREATE TABLE `debrief` (
  `DebriefID` bigint NOT NULL,
  `ActualStartTime` time DEFAULT NULL,
  `ActualStopTime` time DEFAULT NULL,
  `Hours` time DEFAULT NULL,
  `MissionStatus` enum('complete','incomplete') DEFAULT NULL,
  `MDT` int DEFAULT NULL,
  `MIRT` varchar(255) DEFAULT NULL,
  `ScheduledStartTime` time DEFAULT NULL,
  `ScheduledStopTime` time DEFAULT NULL,
  `ScheduledHours` time GENERATED ALWAYS AS (timediff(`ScheduledStopTime`,`ScheduledStartTime`)) VIRTUAL,
  `Debriefer` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `debrief`
--
...
INSERT INTO `devices` VALUES (1,'hh-60'),(2,'767'),(3,'c172');
...
INSERT INTO `logistics` VALUES (11,'ADI',10,'51c',200,3,'123-ABC','Sample Note 1',20,'Vendor1','1','456','789','Electrical','Vendor1','2023-01-01',1,30),(12,'MFD',10,'55a',250,3,'456-DEF','Sample Note 2',30,'Vendor2','2','789','012','Electrical','Vendor2','2023-01-02',2,20),(13,'HSI',10,'53c',150,3,'789-GHI','Sample Note 3',15,'Vendor3','3','012','345','Electrical','Vendor3','2023-01-03',3,50),(14,'Windscreen',10,'54b',300,1,'012-JKL','Sample Note 4',25,'Vendor4','4','345','678','Electrical','Vendor4','2023-10-18',4,30),(15,'Battery',100,'100a',20,3,'123-ABC','Sample Note 5',2,'Vendor1','5','456','789','Electrical','Vendor1','2023-09-18',1,50),(16,'Bandaids',100,'101b',5,2,'456-DEF','Sample Note 6',1,'Vendor2','6','789','012','Hydraulic','Vendor2','2023-09-17',2,30),(17,'Screws',100,'102c',10,3,'789-GHI','Sample Note 7',1.5,'Vendor3','7','012','345','Hydraulic','Vendor3','2023-09-13',3,1),(18,'Tire',4,'1d',400,4,'012-JKL','Sample Note 8',40,'Vendor4','8','345','678','Hydraulic','Vendor4','2023-09-12',4,5),(19,'Landing Gear',2,'2a',1000,3,'123-ABC','Sample Note 9',100,'Vendor1','9','456','789','Hydraulic','Vendor1','2023-09-10',1,2),(20,'Aircraft Shell',1,'3d',5000,3,'456-DEF','Sample Note 10',500,'Vendor2','10','789','012','Hydraulic','Vendor2','2023-09-10',2,1),(21,'ADI',10,'51c',200,2,'123-ABC','Sample Note 1',20,'Vendor1','123','456','789','Electrical','Vendor1','2023-09-20',1,22),(22,'MFD',10,'55a',250,3,'456-DEF','Sample Note 2',30,'Vendor2','456','789','012','Electrical','Vendor2','2023-09-22',2,22),(23,'HSI',10,'53c',150,1,'789-GHI','Sample Note 3',15,'Vendor3','789','012','345','Electrical','Vendor3','2023-09-22',3,23),(24,'Windscreen',10,'54b',300,3,'012-JKL','Sample Note 4',25,'Vendor4','012','345','678','Electrical','Vendor4','2023-09-19',4,10),(25,'Battery',100,'100a',20,1,'123-ABC','Sample Note 5',2,'Vendor1','123','456','789','Electrical','Vendor1','2023-09-18',1,101),(26,'Bandaids',100,'101b',5,3,'456-DEF','Sample Note 6',1,'Vendor2','456','789','012','Hydraulic','Vendor2','2023-09-17',2,101),(27,'Screws',100,'102c',10,3,'789-GHI','Sample Note 7',1.5,'Vendor3','789','012','345','Hydraulic','Vendor3','2023-09-13',3,101),(28,'Tire',50,'1d',400,3,'012-JKL','Sample Note 8',40,'Vendor4','012','345','678','Hydraulic','Vendor4','2023-09-12',4,50),(29,'Landing Gear',50,'2a',1000,3,'123-ABC','Sample Note 9',100,'Vendor1','123','456','789','Hydraulic','Vendor1','2023-09-12',1,50),(30,'Aircraft Shell',50,'3d',5000,3,'456-DEF','Sample Note 10',500,'Vendor2','456','789','012','Hydraulic','Vendor2','2023-09-10',2,50),(31,'Laser',1,'11a',1,3,'1','laser level for testing',0,'Phillip','1','1','1','Computers',NULL,NULL,3,1),(32,'Standby ADI',1,'10A',5000,3,'1111','New Adi entered',2000,'Rockwell Collins','111','111','111','Avionics',NULL,NULL,3,1),(33,'LCOS Projectors',5,'22A',15000,3,'1111','none',700,'Rockwell Collins','1111','2222','1234','Computers',NULL,NULL,3,5);
...
--
-- Table structure for table `mission_profiles`
--

DROP TABLE IF EXISTS `mission_profiles`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mission_profiles` (
  `mission_profile_id` int NOT NULL AUTO_INCREMENT,
  `mission_profile_name` varchar(255) NOT NULL,
  PRIMARY KEY (`mission_profile_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mission_profiles`
--
...
INSERT INTO `timeentries` VALUES (1,20230315001,3,'2023-08-14',2.00,'Time entry for work order 20230315001'),(2,20230315001,2,'2023-08-15',1.50,'Time entry for work order 20230315001'),(3,20230315002,1,'2023-08-16',3.00,'Time entry for work order 20230315002'),(4,20230315002,2,'2023-08-17',2.00,'Time entry for work order 20230315002'),(5,20230401001,3,'2023-08-18',4.00,'Time entry for work order 20230401001'),(6,20230401001,1,'2023-08-19',1.00,'Time entry for work order 20230401001'),(7,20230409001,2,'2023-08-14',1.50,'Time entry for work order 20230409001'),(8,20230525001,3,'2023-08-15',2.50,'Time entry for work order 20230525001'),(9,20230525002,1,'2023-08-16',3.50,'Time entry for work order 20230525002'),(10,20230613003,2,'2023-08-17',3.75,'Time entry for work order 20230613003'),(11,20230213001,3,'2023-08-18',1.00,'Time entry for work order 20230213001'),(12,20230525003,2,'2023-08-19',4.50,'Time entry for work order 20230525003'),(13,20230613002,3,'2023-08-14',2.75,'Time entry for work order 20230613002'),(14,20230613002,6,'2023-08-15',1.00,'Time entry for work order 20230613002'),(15,20230613001,5,'2023-08-16',1.75,'Time entry for work order 20230613001');
...
INSERT INTO `workorder_parts` VALUES (1,20230613003,1,10,'added','2023-08-19'),(2,20230525003,2,5,'added','2023-08-19'),(3,20230315001,3,8,'added','2023-08-19');
...
INSERT INTO `workorders` VALUES (20230213001,1,1,'2023-09-16','2023-09-16',1,'Initial work order','Test was completed','Part1',NULL,NULL,3,'bob','note 1',1,'AWM'),(20230315001,2,2,'2023-09-16','2023-09-16',2,'Scheduled work order','Work order completed','Part2','2023-09-19',3,2,'cory','No additional notes',2,'AWM'),(20230315002,3,3,'2023-09-16','2023-09-16',3,'Emergency work order','Work order completed','Part3',NULL,NULL,1,'daisy','replaced emergency',3,'AWT'),(20230401001,4,4,'2023-09-14','2023-09-14',4,'Regular work order','Work order completed','Part4','2023-09-19',5,3,'emma','No additional notes',4,'AWE'),(20230409001,5,1,'2023-09-16','2023-09-16',1.5,'Unscheduled work order','Work order completed','Part5',NULL,NULL,2,'frank','No additional notes',1.5,'AWM'),(20230525001,6,2,'2023-09-14','2023-09-14',2.5,'Scheduled work order','Work order completed','Part6','2023-09-19',2,3,'gene','No additional notes',2.5,'AWT'),(20230525002,1,3,'2023-09-14','2023-09-14',3.5,'Emergency work order','Work order completed','Part7',NULL,NULL,1,'john','No additional notes',3.5,'AWE'),(20230525003,2,4,'2023-09-16','2023-09-16',4.5,'Regular work order','Work order completed','Part8','2023-09-19',4,2,'kyle','No additional notes',4.5,'AWM'),(20230613001,3,1,'2023-09-14','2023-09-14',1.75,'Unscheduled work order','Work order completed','Part9',NULL,NULL,3,'lucy','No additional notes',1.75,'AWT'),(20230613002,4,2,'2023-09-16','2023-09-16',2.75,'Scheduled work order','Work order completed','Part10','2023-09-19',6,3,'jean','No additional notes',2.75,'AWE'),(20230613003,5,3,'2023-09-15','2023-09-15',3.75,'Emergency work order','Work order completed','Part11','2023-09-17',2,2,'daisy','No additional notes',3.75,'AWM'),(20230625001,7,2,'2023-09-16',NULL,NULL,'Removed Panel','Montly battery test.',NULL,NULL,NULL,3,NULL,NULL,NULL,'AWM'),(20230625002,1,1,'2023-09-16',NULL,NULL,'Missing Pilots ADI olol','Pilots ADI was removed for repair.',NULL,'2023-08-20',2,3,NULL,NULL,NULL,'AWM'),(20230627001,1,1,'2023-09-16',NULL,NULL,'IOS is slow to respond','IOS has low memor',NULL,'2023-08-20',2,3,'emma',NULL,NULL,'AWE'),(20230627002,1,1,'2023-09-15',NULL,NULL,'During flight sim locked up\naa','Hard drive failed',NULL,NULL,NULL,3,'emma',NULL,NULL,'AWM'),(20230627003,2,3,'2023-09-16',NULL,NULL,'Preflight required','Daily preflight required by SOP.',NULL,'2023-08-20',2,3,'emma',NULL,NULL,'AWM'),(20230627004,1,1,'2023-09-15',NULL,NULL,'magic','dust',NULL,NULL,NULL,3,'paul',NULL,NULL,'AWM'),(20230707001,1,1,'2023-09-15',NULL,NULL,'one','one',NULL,NULL,NULL,3,'Paul',NULL,NULL,'AWM'),(20230820001,1,3,'2023-08-20',NULL,NULL,'Failed HSI','none',NULL,NULL,NULL,3,'Anderson',NULL,NULL,'AWM');
